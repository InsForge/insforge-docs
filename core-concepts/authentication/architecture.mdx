...
<CardGroup cols={2}>
  <Card title="RSA Signing" icon="signature">
    Tokens signed with 2048-bit RSA private key, verified with public key
  </Card>
  ...
  <Card title="Secure Sessions" icon="clock">
    Database-backed sessions with automatic expiry
  </Card>
...
### _accounts Table (Core Authentication)
...
| Column | Type | Description |
|--------|------|-------------|
| `id` | UUID | Foreign key to _accounts(id) |
| `nickname` | TEXT | Display name/username |
...
### _oauth_connections Table

| Column | Type | Description |
|--------|------|-------------|
| `id` | UUID | Connection ID |
| `user_id` | UUID | Foreign key to _accounts |
...
| Feature | InsForge | Firebase Auth | Auth0 | Supabase |
|---------|----------|--------------|-------|----------|
| **JWT Tokens** | ✅ RS256 | ✅ RS256 | ✅ Multiple | ✅ HS256 |
| **OAuth Providers** | Google, GitHub | 20+ providers | 50+ providers | 15+ providers |
| **Session Storage** | ❌ Stateless | ❌ Stateless | ✅ Custom | ✅ PostgreSQL |
| **Custom Claims** | ✅ | ✅ | ✅ | ✅ |
| **Self-Hosted** | ✅ | ❌ | ❌ | ✅ |
| **Open Source** | ✅ | ❌ | ❌ | ✅ |