...
|----------------|-----------|-------|
| `TEXT`, `VARCHAR` | string | All strings use TEXT internally |
| `INTEGER` | number | 32-bit integers |
| `BIGINT` | string | Large integers as strings to prevent overflow |
...
| `JSONB` | object/array | Native JSON storage |
